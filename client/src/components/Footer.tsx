        ...
        <div id='footer' className='w-full place-self-end '>
            <div className='flex flex-col sm:flex-row  justify-between items-center bg-green p-1 sm:py-3'>
                ...
                <div className='flex justify-between gap-2 items-center  sm:mr-7'>
                    <a href="https://www.instagram.com/camilokotecki/"target={"_blank"}><img src={insta} alt="Instagram" className=' w-5 h-5 sm:w-6 sm:h-6 ' /></a>
                    <a href="https://www.facebook.com/camilokotecki"target={"_blank"}> <img src={face} alt="Facebook" className=' w-5 h-5 sm:w-6 sm:h-6' /></a>
                    <a href="https://mail.google.com/mail/u/0/?ogbl#inbox?compose=DmwnWrRrlzsMxxLhmGtFzwvpsrFjxzpSwvXfbVqbrRLfRktlqlKdpbwWhdcsjQTzDWVXhcjFzhVb"target={"_blank"}><img src={goog} alt="Google" className=' w-5 h-5 sm:w-6 sm:h-6' /></a>
                    <a href="https://www.linkedin.com/in/camilodeassis/"target={"_blank"}><img src={linkd} alt="Linkedin" className=' w-5 h-5 sm:w-6 sm:h-6' /></a>
                    <a href="https://github.com/CamilodeAssis" target={"_blank"}><img src={gith} alt="GitHub" className='w-5 h-5 sm:w-6 sm:h-6' /></a>
                </div>
            </div>
            ...
            <div className='dark:bg-black  bg-gray-400 h-auto flex flex-col sm:flex-row justify-center items-center  p-3 sm:p-5'>
                ...
                <div className='bg-white w-48 h-[1px] sm:h-20 sm:w-[1px] mb-4 mt-2 sm:my-0 sm:mx-24'></div>
                ...
                <div className='text-white flex flex-col items-center justify-center '>
                    ...
                    <ul className='sm:text-base text-[10px] mt-2 f tracking-widest'>
            ...
            <div className='bg-black flex  justify-center items-center py-1'>
                <span className='text-white text-[10px] sm:text-sm  text-center'>2022-2022 - Todos direitos reservados - Camilo de Assis</span>
            </div>
        </div>
    );
}