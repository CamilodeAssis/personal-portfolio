        ...
        <div id='home' className="bg-white dark:bg-gray-400  h-full sm:h-screen flex flex-col justify-center items-center pt-20  p-10 w-full">
            ...
            <div className='flex justify-between items-center mt-6 cursor-pointer'>
                <a href="https://github.com/CamilodeAssis" target={"_blank"} >
                    <div className='flex justify-center items-center mr-4 text-white bg-gray-700 rounded w-auto p-1 hover:bg-gray-400 dark:hover:bg-gray-900 shadow-md'>
            ...
            <img className='rounded-full w-52 h-52 sm:w-64 sm:h-64 mt-8 border dark:border-green shadow-md shadow-gray-400 dark:shadow-gray-700' src={img} alt="Camilo de Assis" />

            <a href={pdf} target={"_blank"} >
                <div className='flex gap-2 justify-center items-center mr-4 shadow-md dark:text-white dark:bg-green border  dark:border-none hover:bg-green hover:text-white dark:hover:bg-green-hover dark:hover:text-gray-100 rounded w-auto py-1 px-2 mt-8'>
