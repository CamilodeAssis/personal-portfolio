    ...
    return (
        <div className=' flex fixed justify-between  items-center  sm:h-auto h-16 sm:pb-3 sm:pt-3  bg-gray-700 w-full ' >
            ...
            <div className='hidden sm:flex justify-center items-center text-white mr-7 cursor-pointer'>
                ...
                <Link className='ml-6' to="home" smooth={true} offset={-200} duration={500} >Home</Link>
                <Link className='ml-6' to="sobre" smooth={true} offset={0} duration={500}>Sobre</Link>
                <Link className='ml-6' to='skills' smooth={true} offset={0} duration={500}>Skills</Link>
                <Link className='ml-6' to='projetos' smooth={true} offset={0} duration={500}>Projetos</Link>
                <Link className='ml-6' to='contato' smooth={true} offset={0} duration={500}>Contato</Link>
            </div>
            {/* MOBILE BUTTON  v*/}
